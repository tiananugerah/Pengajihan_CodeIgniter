<aside class="left-side sidebar-offcanvas">                
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="pekerjaan">
                                <i class="fa fa-briefcase"></i> <span>Data Pekerjaan</span>
                            </a>
                        </li>
                        <li>
                            <a href="gaji">
                                <i class="fa fa-dollar"></i> <span>Gaji Karyawan</span>
                            </a>
                        </li>
                        <li>
                            <a href="konfirmasi">
                                <i class="fa fa-comments"></i> <span>Kofirmasi Gajih</span>
                            </a>
                        </li>
                        <li class="treeview">
                            <a href="#">
                        ...
                        <li>
                            <a href="app/slip_gaji/<?php echo $data->nik; ?>/<?php echo $data->tgl; ?>">
                                <i class="fa fa-dollar"></i> <span>Lihat gaji</span>
                            </a>
                        </li>
                        <li>
                            <a href="app/konfirmasi/<?php echo $this->session->userdata('id_user'); ?>">
                                <i class="fa fa-comments"></i> <span>Kofirmasi Gajih</span>
                            </a>
                        </li>
                        <li>
